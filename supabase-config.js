...
/* Dependencias geográficas síncronas, cargadas antes de app.js. */
if (!window.__RADAR_POSTAL_BASE_LOADED__) {
  window.__RADAR_POSTAL_BASE_LOADED__ = true;
  document.write('<script src="./v12.js?v=13.2.2"><\/script>');
  document.write('<script src="./v12-geo-compact.js?v=13.2.2"><\/script>');
  document.write('<script src="./catalog-loader.js?v=13.2.2"><\/script>');
}
